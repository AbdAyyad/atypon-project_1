...
public class CacheFactory {
    ...
    private static Cache<Journal> journalCache;
    ...
    public synchronized static Cache<Journal> getJournalCacheInstance(String folder) {
        if (journalCache == null) {
            journalCache = new Cache<>(Constants.CACHE_SIZE, folder);
        }
        return journalCache;
    }
}
